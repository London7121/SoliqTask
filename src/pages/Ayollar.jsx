...
export default function erkakalr() {
    ...
    return (
        <div>
            <div id="ayollar" className="my-16 h-auto">
                <p className='text-red-500 text-[28px] font-bold text-center lg:text-start'>Ayollar uchun</p>
