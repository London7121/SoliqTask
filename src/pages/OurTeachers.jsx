...
import { our_teachers } from '../data/data'

export default function OurTeachers({ onProductClick }) {
    return (
        <div>
            <div id="teachers" className="my-16 h-auto py-2">
                    ...
                    {our_teachers.map((product) => (
                        <div
                            ...
                            onClick={() => onProductClick({
                                ...
                                features: ["Sifatli mahsulot", "Qulay narx", "Tezkor yetkazib berish"]
                            })}
                        >
