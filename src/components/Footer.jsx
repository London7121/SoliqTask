                ...
                <div className="mx-auto max-w-screen-xl">
                    <div className="md:flex md:justify-between">
                        <div className="mb-6 md:mb-0">
                            ...
                            <p className="mb-6 w-[300px] text-md font-semibold text-gray-700 dark:text-white">Biz sizga mahsulot sotish uchun bu yerda emasmiz, biz tajribamiz orqali
                                qiymat sotamiz.</p>
                        </div>
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 ml-12">
                            <div>
                                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Manzil</h2>
                                <ul className="text-gray-600 dark:text-gray-400">
                                    <li className="mb-4">
                                        <a href="#" className="hover:underline">Toshkent shahri, Yunusobod tumani, ko'ch. Amir Temur 129B</a>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Yordam</h2>
                                <ul className="text-gray-600 dark:text-gray-400">
                                    <li className="mb-4">
                                        <a href="tel:+998997443010" className="hover:underline ">+998 99 744 30 10</a>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Pochta</h2>
                                <ul className="text-gray-600 dark:text-gray-400">
                                    <li className="mb-4">
                                        <a href="https://t.me/Poweruz1" className="hover:underline">Power.uz</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 POWER.UZ copyright Kamol Juraev
                        </span>
                        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                            <a href="https://www.instagram.com/pover.uz/profilecard/?igsh=MTR3bDZuanB2c3g5eA==" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
